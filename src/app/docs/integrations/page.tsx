    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="card-glass p-6 mb-8">
          <h2 className="text-2xl font-bold text-white mb-4">Hybrid Architecture (Recommended)</h2>
          ...
          <div className="flow-diagram mb-6">
            <div className="flow-step bg-blue-500/20 border-blue-500">
              <div className="text-white font-bold">Incoming Job</div>
              <div className="text-gray-300 text-sm">Analyze complexity</div>
            </div>
            <div className="text-gray-400 text-2xl">↓</div>
            <div className="grid grid-cols-3 gap-4 w-full">
              <div className="flow-step bg-green-500/20 border-green-500">
                <div className="text-white font-bold">Simple (0-3)</div>
                <div className="text-gray-300 text-sm">Internal Engine</div>
                <div className="text-green-400 text-xs">80% of jobs</div>
              </div>
              <div className="flow-step bg-yellow-500/20 border-yellow-500">
                <div className="text-white font-bold">Medium (4-6)</div>
                <div className="text-gray-300 text-sm">Robocorp Cloud</div>
                <div className="text-yellow-400 text-xs">15% of jobs</div>
              </div>
              <div className="flow-step bg-red-500/20 border-red-500">
                <div className="text-white font-bold">Complex (7-10)</div>
                <div className="text-gray-300 text-sm">UiPath Orchestrator</div>
                <div className="text-red-400 text-xs">5% of jobs</div>
              </div>
            </div>
          </div>

          <div className="bg-blue-500/20 p-4 rounded">
            <h3 className="text-white font-semibold mb-2">Complexity Scoring Factors:</h3>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
            <span className="text-purple-400">🤖</span> Option 1: UiPath Orchestrator
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="card-glass p-6">
              <h3 className="text-xl font-bold text-white mb-3">Pricing (USD/month)</h3>
              <div className="space-y-4">
                <div className="bg-purple-500/20 p-4 rounded">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-gray-300">UiPath Studio Pro</span>
                    <span className="text-white font-bold">$420/month</span>
                  </div>
                  <div className="text-gray-400 text-xs">Per developer license</div>
                </div>
                <div className="bg-purple-500/20 p-4 rounded">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-gray-300">UiPath Orchestrator</span>
                    <span className="text-white font-bold">$1,500/month</span>
                  </div>
                  <div className="text-gray-400 text-xs">Standard tier (10 robots)</div>
                </div>
                <div className="bg-purple-500/20 p-4 rounded">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-gray-300">UiPath AI Center</span>
                    <span className="text-white font-bold">$2,000/month</span>
                  </div>
                  <div className="text-gray-400 text-xs">Document AI + ML models</div>
                </div>
                <div className="bg-purple-500/20 p-4 rounded">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-gray-300">Additional Robots</span>
                    <span className="text-white font-bold">$280/month</span>
                  </div>
                  <div className="text-gray-400 text-xs">Per unattended robot</div>
                </div>
                <div className="border-t border-purple-500 pt-4">
                  <div className="flex justify-between items-center">
                    <span className="text-white font-bold text-lg">Total (Basic Setup)</span>
                    <span className="text-purple-400 font-bold text-2xl">$4,200/month</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-2">
            <span className="text-blue-400">🐍</span> Option 2: Robocorp Cloud
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="card-glass p-6">
              ...
              <div className="space-y-4">
                <div className="bg-blue-500/20 p-4 rounded">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-gray-300">Robocorp Cloud Starter</span>
                    <span className="text-white font-bold">$0/month</span>
                  </div>
                  <div className="text-gray-400 text-xs">5,000 run minutes/month included</div>
                </div>
                <div className="bg-blue-500/20 p-4 rounded">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-gray-300">Robocorp Cloud Pro</span>
                    <span className="text-white font-bold">$99/month</span>
                  </div>
                  <div className="text-gray-400 text-xs">50,000 run minutes/month</div>
                </div>
                <div className="bg-blue-500/20 p-4 rounded">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-gray-300">Additional Minutes</span>
                    <span className="text-white font-bold">$0.002/min</span>
                  </div>
                  <div className="text-gray-400 text-xs">Pay-as-you-go pricing</div>
                </div>
                <div className="bg-blue-500/20 p-4 rounded">
                  <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="text-gray-400 text-xs">Priority support + SLA</div>
                </div>
                <div className="border-t border-blue-500 pt-4">
                  <div className="flex justify-between items-center">
                    <span className="text-white font-bold text-lg">Total (Typical Usage)</span>
                    <span className="text-blue-400 font-bold text-2xl">$198/month</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Cost Comparison */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-white mb-4">Cost Comparison (USD/month)</h2>
          <div className="card-glass p-6">
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-gray-600">
                    <th className="py-3 px-4 text-white font-semibold">Strategy</th>
                    <th className="py-3 px-4 text-white font-semibold">Monthly Cost (USD)</th>
                    <th className="py-3 px-4 text-white font-semibold">Job Distribution</th>
                ...
                <tbody className="text-gray-300">
                  <tr className="border-b border-gray-700">
                    <td className="py-3 px-4">
                      <span className="font-semibold text-white">Internal Only</span>
                      <div className="text-xs text-gray-400">Platform built-in</div>
                    </td>
                    <td className="py-3 px-4">
                      <span className="text-green-400 font-bold">$0</span>
                      <div className="text-xs">Included in platform</div>
                    </td>
                  ...
                  <tr className="border-b border-gray-700">
                    <td className="py-3 px-4">
                      <span className="font-semibold text-white">Robocorp Only</span>
                      <div className="text-xs text-gray-400">Cloud-native</div>
                    </td>
                    <td className="py-3 px-4">
                      <span className="text-blue-400 font-bold">$198</span>
                      <div className="text-xs">Pro plan + support</div>
                    </td>
                  ...
                  <tr className="border-b border-gray-700">
                    <td className="py-3 px-4">
                      <span className="font-semibold text-white">Hybrid (Recommended)</span>
                      <div className="text-xs text-gray-400">Intelligent routing</div>
                    </td>
                    <td className="py-3 px-4">
                      <span className="text-yellow-400 font-bold">$700</span>
                      <div className="text-xs">Robocorp Pro + minimal UiPath</div>
                    </td>
                  ...
                  <tr>
                    <td className="py-3 px-4">
                      <span className="font-semibold text-white">UiPath Only</span>
                      <div className="text-xs text-gray-400">Enterprise-grade</div>
                    </td>
                    <td className="py-3 px-4">
                      <span className="text-red-400 font-bold">$4,200</span>
                      <div className="text-xs">Studio + Orchestrator + AI</div>
                    </td>
            ...
            <div className="mt-6 grid md:grid-cols-3 gap-4">
              <div className="bg-green-500/20 p-4 rounded text-center">
                <div className="text-2xl font-bold text-green-400">83% savings</div>
                <div className="text-gray-300 text-sm">Hybrid vs UiPath-only</div>
              </div>
              <div className="bg-blue-500/20 p-4 rounded text-center">
                <div className="text-2xl font-bold text-blue-400">15x ROI</div>
                <div className="text-gray-300 text-sm">First-year returns (typical)</div>
              </div>
              <div className="bg-purple-500/20 p-4 rounded text-center">
                <div className="text-2xl font-bold text-purple-400">2-4 weeks</div>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-white mb-4">Integration Setup</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="card-glass p-6">
...
ROBOCORP_API_KEY=your-api-key`}
            ...
            <div className="card-glass p-6">
              <h3 className="text-white font-semibold mb-3">Automatic Job Routing</h3>
              <div className="code-block">
                <code className="text-green-400 text-xs">
...
└─────────────────────────────────────────────────────────────────┘`}
        ...
        <section className="mb-8">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <div className="card-glass p-4">
              <div className="text-3xl font-bold text-green-400 mb-2">Week 2</div>
            ...
            <div className="card-glass p-4">
              <div className="text-3xl font-bold text-yellow-400 mb-2">Week 3</div>
        ...
        <section className="mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <a href="/docs/networks" className="card-glass p-6 hover:border-blue-500 transition-colors">
              ...
              <p className="text-gray-300 text-sm">Supported payment processors and banking platforms</p>
            </a>
            <a href="/docs/setup" className="card-glass p-6 hover:border-blue-500 transition-colors">
              ...
              <p className="text-gray-300 text-sm">Analytics and reporting integration guide</p>
            </a>
            <a href="/docs/pricing" className="card-glass p-6 hover:border-blue-500 transition-colors">
              ...
              <p className="text-gray-300 text-sm">Complete deployment tier pricing (all in USD)</p>
            </a>
          </div>
        </section>
